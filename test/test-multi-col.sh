...
oncogemini query --header -q "select v.variant_id, v.chrom, v.start, v.ref, v.alt, v.gene, v.biotype, i.gene, i.variant_id, i.biotype, i.transcript from variants\
                          v, variant_impacts i where v.variant_id=i.variant_id and v.variant_id = 1 and i.gene = 'FAM138A'" test.query.db > obs
check obs exp
